///Build function to read json file
function buildMetaData(sample) {
    ...
    //Add each key and value pair to the panelData
...
function buildCharts(sample) {
  ...
  function init() {
    // Grab a reference to the dropdown element
    var selectDropdown = d3.select("#selDataset");

    // Populate by using the list of sample names
    d3.json("samples.json").then((data) => {
      var name = data.names;
